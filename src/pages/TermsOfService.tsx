        ...
        >
          ...
          <section id="privacy" className="glass-card rounded-xl md:rounded-2xl p-5 md:p-8 scroll-mt-20">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <a href="/privacy" className="inline-flex items-center gap-2 px-3 py-1.5 bg-cyan-500/10 rounded-lg text-cyan-400 text-sm hover:bg-cyan-500/20 transition-colors">
